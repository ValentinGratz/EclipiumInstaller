...
namespace EclipiumInstaller
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            InitializeInstaller("{AppName}", "{PackageUrl}");
        }

        private void InitializeInstaller(string AppName,string AppUrl) 
        {
        ...
        Stream GetStreamFromFile(string filename)
        {
            ...
            var stream = assembly.GetManifestResourceStream("EclipiumInstalller." + filename);
        ...
        private async void Completed(object sender, AsyncCompletedEventArgs e)
        {
            ...
            { 
                ...
                var a = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles);
                ...
                SaveStreamAsFile(a + "\\Eclipium\\" + f.Name, remover, "Remove.exe");
